...
10. I tried for the code to met the accessibility checks, using `fieldset` and `label` for each input in the form, and to use the correct HTML to build the table.
